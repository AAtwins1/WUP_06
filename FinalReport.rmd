...
The inferential results proves that there is a difference between the white and other communities, as well as, the black and other communities regarding which side they each stand with capital punishment. This can be shown through the p-values shown respectively.
